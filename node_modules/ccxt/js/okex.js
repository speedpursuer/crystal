...
module.exports = class okex extends okcoinusd {
    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'markets': {
                'BTC/USD': { 'id': 'btc_usdt', 'symbol': 'BTC/USD', 'base': 'BTC', 'quote': 'USD', 'type': 'spot', 'spot': true, 'future': false },
                ...
                'BCH/BTC': { 'id': 'bcc_btc', 'symbol': 'BCH/BTC', 'base': 'BCC', 'quote': 'BTC', 'type': 'spot', 'spot': true, 'future': false },
            },
        });
    }
}
