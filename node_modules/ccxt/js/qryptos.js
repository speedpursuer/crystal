...
module.exports = class qryptos extends Exchange {
    ...
    async fetchOpenOrders (symbol = undefined, params = {}) {
        ...
        // let market = this.market (symbol);
        // let market = this.market (symbol);
        // let states = ['submitted', 'partial-filled'];
        ...
        return this.parseOrders(response['models'], this.marketId (symbol));
    }

    parseOrders (data, productID) {
        var result = []
        for (let i = 0; i < data.length; i++) {
            if(data[i].status == 'live' && data[i].product_id == productID) {
                result.push(data[i])
            }
        }
        return result
