...
module.exports = class bitfinex2 extends bitfinex {
    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'markets': {
                ...
                'IOT/BTC': { 'id': 'tIOTBTC', 'symbol': 'IOTA/BTC', 'base': 'IOT', 'quote': 'BTC' },
                'IOT/ETH': { 'id': 'tIOTETH', 'symbol': 'IOTA/ETH', 'base': 'IOT', 'quote': 'ETH' },
                'IOT/USD': { 'id': 'tIOTUSD', 'symbol': 'IOTA/USD', 'base': 'IOT', 'quote': 'USD' },
    ...
    async fetchOpenOrders (symbol) {
        let market = this.market (symbol);
        let response = await this.privatePostAuthROrdersSymbol({
            'symbol': market['id'],
        });
